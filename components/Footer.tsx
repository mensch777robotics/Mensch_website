                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-10">
                    <div className="max-w-sm">
                        ...
                        <p className="text-slate-400 text-sm font-body leading-relaxed">
                            Pioneering the future of physical AI with robots that serve, teach, and innovate. We build the bodies for the minds of tomorrow.
                        </p>
                    </div>
                    <div className="flex gap-16 flex-wrap">
                        <div>
                            <h4 className="text-white font-bold text-xs uppercase tracking-widest mb-6">Robots</h4>
